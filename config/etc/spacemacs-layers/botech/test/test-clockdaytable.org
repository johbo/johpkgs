...
#+BEGIN: clockdaytable :tags "-notbill" :maxlevel 30 :scope file-with-archives :block 2017-03 :formatter botech/format-daily-clocklines :properties ("issue" "work_type" "user") :inherit-props t :dump-data nil :stepskip0 t :fileskip0 t
